import { PromptTemplate, PromptCategory, ResponseType } from '../types/prompt-library.js';
...
export const IOS_PROMPT_TEMPLATES: Record<string, PromptTemplate> = {
  ...
  'swift-code-generator': {
    ...
    category: 'swift-development' as PromptCategory,
...
- Testing requirements: {testingRequirements}`,
    ...
    responseType: 'structured' as ResponseType,
    temperature: 0.3,
  ...
  'swiftui-component-creator': {
    ...
    category: 'swiftui-development' as PromptCategory,
...
- Performance considerations: {performanceRequirements}`,
  ...
  'xcode-automation': {
    id: 'xcode-automation',
    category: 'xcode-tools' as PromptCategory,
...
export const validateIOSTemplate = (template: PromptTemplate): boolean => {
  return !!(
    template.id &&
    template.category &&
    template.name &&
...
export const getIOSTemplateById = (id: string): PromptTemplate | undefined => {
  return IOS_PROMPT_TEMPLATES[id];
};

export const getIOSTemplatesByCategory = (category: string): PromptTemplate[] => {
  return Object.values(IOS_PROMPT_TEMPLATES).filter(
    template => template.category === category
  );
};

export const getAllIOSTemplates = (): PromptTemplate[] => {
