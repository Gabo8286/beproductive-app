...
CREATE TABLE public.api_usage_analytics (
  ...
  INDEX (provider, requested_at),
  INDEX (success, requested_at)
);
...
-- API Keys: Only super_admin can access
...
-- System Limits: Only super_admin can access
...
-- Usage Analytics: Only super_admin can access
...
-- Audit Log: Only super_admin can access
...
-- System Config: Only super_admin can access
...
-- Function to get current month usage for an API key
