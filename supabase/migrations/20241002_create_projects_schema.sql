...
-- Complete implementation for project management with task/goal integration
...
-- Add project_id to existing goals table
...
-- Function to calculate project progress from tasks
...
BEGIN
  ...
  IF TG_OP = 'INSERT' OR TG_OP = 'UPDATE' THEN
    ...
    -- If project_id changed in UPDATE, recalculate old project too
