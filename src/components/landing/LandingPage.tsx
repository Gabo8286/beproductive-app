...
export const LandingPage = () => {
  const { personalizationData, trackEvent, trackBehavior, getEngagementLevel } =
    useConversionTracking();

  const { showExitIntent, resetExitIntent } = useExitIntent();
  const [showEmailModal, setShowEmailModal] = useState(false);
  const [emailModalTrigger, setEmailModalTrigger] = useState<
    "exit" | "scroll" | "time" | "engagement"
  >("exit");
  ...
  const handleEmailCapture = (email: string) => {
    trackEvent(
      ConversionEventType.EMAIL_CAPTURE,
      { email, trigger: emailModalTrigger },
      10,
    );
    ...
    <div className="min-h-screen bg-gradient-hero">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="glass-hero rounded-3xl p-8 md:p-16 text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Define your destinations, pack your essentials, build daily
              routines, and navigate your path to success. BeProductive guides
              ambitious professionals through proven frameworks that transform
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Every successful journey needs a clear destination, a packed
            checklist, daily routines, and moments to reflect on progress.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                whether advancing your career, building skills, or achieving
                personal growth.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Break down complex projects into actionable tasks. Organize
                essentials with smart prioritization, deadlines, and subtasks
          ...
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                tracking, reminders, and celebration milestones. Small daily
                commitments create momentum for lasting change.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pause for thoughtful reflection with guided journaling prompts.
                Capture lessons, track mood patterns, and adjust your strategy
                based on real insights from your journey.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Quickly jot down thoughts, ideas, and reminders that emerge
                along your path. Keep mental clarity with a simple capture
                system for everything that matters.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card elevated-card group">
            <CardContent className="pt-8 pb-6 px-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                View real-time dashboards that map your entire journey. See how
                goals, tasks, habits, and reflections connect to reveal patterns
      ...
      <section className="container mx-auto px-4 py-24 bg-gradient-to-br from-secondary/5 via-background to-primary/5">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Whether you're leading teams, building businesses, or pursuing
            personal growth—BeProductive adapts to your unique path
          </p>
        </div>
        <PersonaSelector
          onPersonaSelect={(personaId) => {
            trackEvent(
              ConversionEventType.QUIZ_COMPLETE,
              { persona: personaId },
              5,
            );
      ...
      <section id="demo" className="container mx-auto px-4 py-24">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Take an interactive tour through a realistic dashboard. See exactly
            how BeProductive transforms your daily workflow—no account required.
          </p>
        </div>
        <DemoContainer
          onDemoStart={() => {
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Whether you're climbing the career ladder, building new skills,
              launching a business, or pursuing personal
              transformation—BeProductive provides the structured framework that
              turns ambitious plans into completed achievements.
            </p>
            <div className="glass-card p-6 rounded-2xl">
              <p className="text-lg font-medium">
                Join thousands who've discovered that commitment + consistency +
                clear direction = goals you actually complete.
              </p>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Discover how professionals across industries use BeProductive to
          ...
          <Card className="journey-card-featured bg-gradient-to-r from-primary to-blue-600 text-white border-0 overflow-hidden relative shadow-2xl">
            <CardContent className="py-16 px-8 md:px-12 text-center relative z-10">
              ...
              <p className="text-xl md:text-2xl mb-10 opacity-95 max-w-2xl mx-auto leading-relaxed">
                Join ambitious professionals, students, entrepreneurs, and
                growth-seekers who've discovered that the right framework turns
                aspirations into achievements. Your destination awaits.
              </p>
              <Button
                size="lg"
                variant="secondary"
                className="apple-button shadow-xl hover:shadow-2xl text-base h-14 px-10 font-medium"
                asChild
              >
                <Link to="/signup">
                  <Sparkles className="h-5 w-5 mr-2" />
