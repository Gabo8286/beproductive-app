  ...
  return (
    <div>
      <DraggableTask task={task}>
        <div
          className={`flex items-center gap-4 p-4 pl-12 border rounded-lg hover:bg-accent/50 transition-colors ${
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                ...
                >
                  <h3
                    className={`font-medium truncate ${task.status === "done" ? "line-through" : ""}`}
                  >
                    {task.title}
                  </h3>
                </Link>
              ...
              {task.assigned_to_profile && (
                <div className="flex items-center gap-1">
                  <Avatar className="w-4 h-4">
                    <AvatarImage
                      src={task.assigned_to_profile.avatar_url || undefined}
                    />
    ...
    <DragAndDropProvider
      ...
      overlay={
        <Card className="opacity-50 rotate-3">
          <CardContent className="p-4">Reordering...</CardContent>
        </Card>
      }
    >
