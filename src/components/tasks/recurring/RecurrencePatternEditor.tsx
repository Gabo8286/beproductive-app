    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <RadioGroup
          ...
          onValueChange={(freq) =>
            updatePattern({ frequency: freq as RecurrencePattern["frequency"] })
          }
        >
      ...
      <div className="space-y-2">
        <Label htmlFor="interval">
          Every {value.interval > 1 ? value.interval : ""}{" "}
      ...
      {value.frequency === "monthly" && (
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              updatePattern({ dayOfMonth: parseInt(e.target.value) || 1 })
            }
            className="w-24"
          />
        </div>
      ...
      <div className="space-y-3">
        ...
        <RadioGroup
          value={endType}
          onValueChange={(type) => setEndType(type as typeof endType)}
        >
          <div className="flex items-center space-x-2">
