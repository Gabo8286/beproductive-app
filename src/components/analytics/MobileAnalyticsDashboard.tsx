        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-muted-foreground">Download insights</div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { icon: Award, title: 'Goal Achiever', description: 'Completed 5 goals this week', color: 'text-yellow-600' },
              { icon: Zap, title: 'Productivity Boost', description: '20% increase in daily tasks', color: 'text-blue-600' },
              { icon: Calendar, title: 'Streak Master', description: '7-day completion streak', color: 'text-green-600' }
