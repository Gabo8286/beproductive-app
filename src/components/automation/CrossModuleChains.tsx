  ...
  const mockChains: WorkflowChain[] = [
    {
      ...
      description:
        "Automatically create tasks when new goals are set and update goal progress when tasks are completed",
      modules: ["goals", "tasks"],
      steps: [
        {
          id: "step1",
    ...
    },
    {
      ...
      description:
        "Track habit completions towards goals and suggest new habits based on goal requirements",
      ...
      success_criteria: {
        ...
        goal_progress_correlation: 0.75,
      },
      performance_metrics: {
    ...
    },
    {
      ...
      description:
        "Execute process steps when project milestones are reached and update project status based on process completion",
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {chain.modules.map((module, index) => {
                  ...
                  const colorClass =
                    moduleColors[module as keyof typeof moduleColors];
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="flex items-center justify-between text-sm mb-1">
                  ...
                  <span>
                    {Math.round(
                      chain.performance_metrics.completion_rate * 100,
                    )}
                    %
                  </span>
                </div>
                <Progress
                  value={chain.performance_metrics.completion_rate * 100}
                  className="h-2"
                />
              </div>
              <div>
                ...
                <Progress
                  value={
                    (chain.performance_metrics.user_satisfaction / 5) * 100
                  }
                  className="h-2"
                />
              </div>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="flex items-center gap-1">
                ...
                {Math.round((1 - chain.performance_metrics.error_rate) * 100)}%
                reliability
              </span>
              <span className="flex items-center gap-1">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Intelligent workflows that connect multiple modules for seamless
            automation
          </p>
        </div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Math.round(
                    (mockChains.reduce(
                      (sum, chain) =>
                        sum + chain.performance_metrics.completion_rate,
                      0,
                    ) /
                      mockChains.length) *
                      100,
