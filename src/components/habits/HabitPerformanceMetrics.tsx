...
import { calculateConsistencyScore, calculateMomentum } from "@/utils/habitAnalytics";
...
export function HabitPerformanceMetrics({ habitId }: HabitPerformanceMetricsProps) {
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold">{consistencyScore.toFixed(0)}</span>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Progress value={(monthAnalytics.average_mood / 5) * 100} className="h-2" />
              <p className="text-sm text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Progress value={(monthAnalytics.average_energy / 10) * 100} className="h-2" />
              <p className="text-sm text-muted-foreground">
