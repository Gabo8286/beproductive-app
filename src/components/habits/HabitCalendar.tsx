...
export function HabitCalendar({ habitId, month, onMonthChange }: HabitCalendarProps) {
          ...
          {days.map(day => {
            ...
            return (
              ...
              >
                ...
                {entry && (
                  <div className={cn("w-2 h-2 rounded-full mx-auto mt-1", getStatusColor(entry.status))} />
                )}
              </div>
            );
          })}
