...
export const UniversalBreadcrumbs: React.FC<UniversalBreadcrumbsProps> = ({
  ...
  const baseClasses = cn(
    ...
    // AppShell styling (above bottom nav)
    layoutContext === 'app-shell' && [
      'bg-background/95 backdrop-blur-sm border-t',
      'fixed bottom-20 left-0 right-0 z-30', // Above bottom nav (h-20)
      'md:bottom-16' // Adjust for desktop bottom nav height
    ],
        ...
        {showBackButton && (
          <>
            <button
              ...
              className={cn(
                'flex items-center gap-2 text-primary text-sm font-medium',
