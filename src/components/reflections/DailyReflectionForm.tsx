...
const formSchema = z.object({
  ...
  mood: z
    .enum(["amazing", "great", "good", "neutral", "bad", "terrible"])
    .optional(),
...
export default function DailyReflectionForm({
  ...
  const [selectedTemplate, setSelectedTemplate] =
    useState<SystemTemplate | null>(null);
  ...
  const handleGuidedFlowComplete = async (
    ...
    const input: CreateReflectionInput = {
      ...
      content,
      reflection_type:
        (selectedTemplate.structure.default_values.reflection_type as any) ||
        "daily",
      reflection_date: format(new Date(), "yyyy-MM-dd"),
      tags: selectedTemplate.tags,
      is_private:
        (selectedTemplate.structure.default_values.is_private as boolean) ??
        true,
      metadata: {
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(date) =>
                      date && setValue("reflection_date", date)
                    }
        ...
        <MoodTracker
          ...
          onSatisfactionChange={(level) =>
            setValue("satisfaction_level", level)
          }
        />
              ...
              {gratitudeItems.map((item, index) => (
                ...
                >
                  ...
                  <Button
                    ...
                    className="h-6 w-6"
                    onClick={() =>
                      handleRemoveItem(gratitudeItems, setGratitudeItems, index)
                    }
                  >
                    <X className="h-3 w-3" />
                  </Button>
            ...
            {tomorrowFocus.map((item, index) => (
              ...
              >
                ...
                <Button
                  ...
                  className="h-6 w-6"
                  onClick={() =>
                    handleRemoveItem(tomorrowFocus, setTomorrowFocus, index)
                  }
                >
                  <X className="h-3 w-3" />
                </Button>
