import { useActiveTimer, useStartTimer, useStopTimer } from '@/hooks/useTimeTracking';
...
export function TimerButton({ taskId, variant = 'ghost', size = 'icon' }: TimerButtonProps) {
