...
export default function Gamification() {
  const { profile, achievements, recentActivity, stats, isLoading } =
    useGamification();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track your productivity growth and achievements
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {stats.points_this_month.toLocaleString()}
                </p>
                      ...
                      const RarityIcon =
                        RARITY_ICONS[
                          achievement.achievement
                            .rarity as keyof typeof RARITY_ICONS
                        ] || Star;
                      return (
                        <div
              ...
              <CardContent>
                <div className="space-y-4">
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <Badge variant="outline">
                            ...
                            {achievement.achievement.requirement_value}
                          </Badge>
                        </div>
                        <Progress
                  ...
                  {achievements.filter(
                    ...
                    <p className="text-gray-500 text-center py-4">
                      Start your productivity journey to see progress!
                    </p>
                  )}
                </div>
              </CardContent>
        ...
        <TabsContent value="achievements" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {achievements.map((achievement) => {
              const RarityIcon =
                RARITY_ICONS[
                  achievement.achievement.rarity as keyof typeof RARITY_ICONS
                ] || Star;
              return (
                <Card
                  key={achievement.achievement.id}
        ...
        <TabsContent value="activity" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your latest productivity achievements
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {recentActivity.map((activity) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatDistanceToNow(new Date(activity.earned_at), {
                          addSuffix: true,
                        })}
                      </p>
                    </div>
                ...
                {recentActivity.length === 0 && (
                  <p className="text-gray-500 text-center py-8">
                    No recent activity. Start completing tasks and setting goals
