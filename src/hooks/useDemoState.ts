...
const getInitialDemoData = (persona: PersonaType): DemoUserData => {
  const baseData = {
    professional: {
      goals: [
        {
          ...
          progress: 75,
          milestones: ['Design wireframes', 'Write content', 'Build MVP', 'Launch'],
        ...
        },
        {
          ...
          progress: 40,
          milestones: ['Join Toastmasters', 'Practice weekly', 'Give 5 presentations'],
          category: 'professional'
        }
      ],
      habits: [
      ...
      tasks: [
        { id: '1', title: 'Prepare Q2 presentation', priority: 'high' as const, status: 'in_progress' as const, dueDate: '2025-04-15' },
        { id: '2', title: 'Review team performance', priority: 'medium' as const, status: 'todo' as const, dueDate: '2025-04-10' },
        { id: '3', title: 'Update project roadmap', priority: 'high' as const, status: 'todo' as const }
      ],
      quickTodos: [
    ...
    student: {
      goals: [
        {
          ...
          progress: 45,
          milestones: ['Q1: 6 books', 'Q2: 6 books', 'Q3: 6 books', 'Q4: 6 books'],
          category: 'personal'
        },
        {
          id: '2',
      ...
      tasks: [
        { id: '1', title: 'Complete math assignment', priority: 'high' as const, status: 'in_progress' as const, dueDate: '2025-04-08' },
        { id: '2', title: 'Research paper draft', priority: 'high' as const, status: 'todo' as const, dueDate: '2025-04-12' },
        { id: '3', title: 'Group project meeting', priority: 'medium' as const, status: 'todo' as const }
      ],
      quickTodos: [
    ...
    entrepreneur: {
      ...
      tasks: [
        { id: '1', title: 'Launch new product feature', priority: 'high' as const, status: 'in_progress' as const, dueDate: '2025-04-20' },
        { id: '2', title: 'Record marketing video', priority: 'medium' as const, status: 'todo' as const, dueDate: '2025-04-10' },
        { id: '3', title: 'Schedule investor meeting', priority: 'high' as const, status: 'todo' as const }
      ],
      quickTodos: [
...
const demoSteps: DemoStep[] = [
  {
    ...
    description: 'Take a quick tour to see how BeProductive can transform your productivity journey.',
    interactions: [],
  ...
  },
  {
    ...
    description: 'This is your command center. All your goals, habits, tasks, and reflections in one place.',
  ...
  },
  {
    ...
    description: 'Break down big dreams into actionable milestones. Track your progress in real-time.',
    highlightTarget: '[data-demo="goals"]',
    interactions: [{ type: 'click', target: '[data-demo="goal-card"]', action: 'View goal', feedback: 'Great! This is how you track goal progress.' }],
    nextStep: 'habits-widget'
  },
  {
    id: 'habits-widget',
    title: 'Build Lasting Habits',
    description: 'Track daily habits and build streaks. Consistency is key to transformation.',
    highlightTarget: '[data-demo="habits"]',
    interactions: [{ type: 'click', target: '[data-demo="habit-complete"]', action: 'Complete habit', feedback: 'Excellent! Watch your streak grow.' }],
    nextStep: 'tasks-widget'
  },
  {
    id: 'tasks-widget',
    title: 'Manage Your Tasks',
    description: 'Organize tasks by priority and status. Never miss a deadline again.',
    highlightTarget: '[data-demo="tasks"]',
    interactions: [{ type: 'click', target: '[data-demo="task-complete"]', action: 'Complete task', feedback: 'Nice work! Keep the momentum going.' }],
    nextStep: 'quick-todos'
  },
  {
    id: 'quick-todos',
    title: 'Quick Travel Notes',
    description: 'Capture quick thoughts and to-dos on the go. Perfect for those spontaneous ideas.',
    highlightTarget: '[data-demo="quick-todos"]',
    interactions: [{ type: 'input', target: '[data-demo="quick-input"]', action: 'Add note', feedback: 'Perfect! Quick capture keeps you organized.' }],
    nextStep: 'completion'
  },
  {
    id: 'completion',
    title: 'Ready to Start Your Journey?',
    description: 'You\'ve seen how BeProductive works. Now it\'s time to create your own success story.',
    interactions: [],
  }
];
...
export function useDemoState() {
  ...
  const nextStep = useCallback(() => {
    const currentStepObj = demoSteps.find(s => s.id === demoState.currentStep);
    if (currentStepObj?.nextStep) {
      setDemoState(prev => ({
        ...prev,
        currentStep: currentStepObj.nextStep!,
        completedSteps: [...prev.completedSteps, prev.currentStep],
        progress: Math.round(((prev.completedSteps.length + 1) / demoSteps.length) * 100)
      }));
    }
  }, [demoState.currentStep]);

  const previousStep = useCallback(() => {
    const currentIndex = demoSteps.findIndex(s => s.id === demoState.currentStep);
    if (currentIndex > 0) {
