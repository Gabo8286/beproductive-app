...
const PRODUCTIVITY_PROFILES: Record<string, ProductivityProfile> = {
  strategist: {
    ...
    name: "The Strategist",
    description:
      "Long-term thinker who excels at planning and seeing the big picture",
    characteristics: [
  ...
  collaborator: {
    ...
    description:
      "Team-focused achiever who thrives through relationships and shared goals",
    characteristics: [
  ...
  optimizer: {
    ...
    name: "The Optimizer",
    description:
      "Efficiency expert who continuously improves systems and processes",
    characteristics: [
  ...
  explorer: {
    ...
    name: "The Explorer",
    description:
      "Curious innovator who thrives on learning and discovering new possibilities",
    characteristics: [
  ...
  perfectionist: {
    ...
    description:
      "Quality-focused achiever who excels at producing exceptional results",
    characteristics: [
  ...
  minimalist: {
    ...
    name: "The Minimalist",
    description:
      "Focus-driven achiever who excels through simplicity and clarity",
    characteristics: [
  ...
  balancer: {
    ...
    name: "The Balancer",
    description:
      "Holistic achiever who integrates work and life for sustainable success",
    characteristics: [
