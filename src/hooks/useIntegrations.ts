...
export const useIntegrations = (status?: IntegrationStatus) => {
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<Integration[]> => {
      ...
      return status ? mockIntegrations.filter(i => i.status === status) : mockIntegrations;
    },
      ...
      const mockProviders: IntegrationProvider[] = [
        {
          ...
          enterprise_features: ['SAML SSO', 'Enterprise Grid', 'Advanced Security'],
          pricing_tier: 'free'
        },
        {
          id: 'google_workspace',
          ...
          supported_features: [
            {
              ...
              supported_actions: ['create_event', 'update_event', 'delete_event'],
      ...
      const mockTemplates: IntegrationTemplate[] = [
        {
          ...
          description: 'Get notified in Slack when tasks are completed or overdue',
          provider_id: 'slack',
        ...
        },
        {
          ...
          description: 'Automatically sync high-priority tasks with your Google Calendar',
          provider_id: 'google_workspace',
          category: 'calendar',
