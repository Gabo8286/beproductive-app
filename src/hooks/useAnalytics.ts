...
const mockReportTemplates: ReportTemplate[] = [
  {
    ...
    description:
      "High-level overview of organizational productivity and performance",
    category: "Executive",
    type: "dashboard",
...
const analyticsAPI = {
  ...
  ): Promise<AnalyticsAPIResponse<AnalyticsDataset>> => {
  ...
  createDashboard: async (
    dashboard: Omit<CustomDashboard, "id" | "created_at" | "updated_at">,
  ...
  getReportTemplates: async (): Promise<
    AnalyticsAPIResponse<ReportTemplate[]>
  > => {
  ...
  createReport: async (
    report: Omit<ScheduledReport, "id" | "created_at" | "updated_at">,
  ...
  exportData: async (
    exportConfig: Omit<
      AnalyticsExport,
      "id" | "status" | "progress_percentage" | "created_at"
    >,
      ...
      return [
        {
          ...
          description:
            "Your task completion rate has increased by 15% over the last 30 days",
          severity: "medium",
        ...
        },
        {
          ...
          description:
            "AI feature usage has increased by 200% this week, indicating high adoption",
          severity: "low",
