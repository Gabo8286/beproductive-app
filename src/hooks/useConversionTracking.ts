...
export function useConversionTracking() {
  ...
  const [commitmentSteps, setCommitmentSteps] = useState<CommitmentStep[]>([
    ...
    },
    {
      id: "email_capture",
      level: 2,
      action: "Shared email for updates",
      completed: false,
    },
    {
      id: "demo_interaction",
      level: 3,
      action: "Tried interactive demo",
      completed: false,
    },
    {
      id: "persona_selection",
      level: 4,
      action: "Identified with persona",
      completed: false,
    },
    {
      id: "signup_start",
      level: 5,
      action: "Started account creation",
      completed: false,
    },
    {
      id: "signup_complete",
