      ...
      const mockSuggestions: AutomationSuggestion[] = [
        {
          ...
          description:
            'Automatically mark tasks as high priority when they contain keywords like "urgent", "ASAP", or have short deadlines.',
          ...
          reasoning:
            "Analysis of your task patterns shows you often manually prioritize tasks with urgent keywords.",
          evidence: [
          ...
          user_patterns_used: [
            "keyword_analysis",
            "manual_prioritization_patterns",
          ],
        ...
        },
        {
          ...
          description:
            "Automatically update goal progress when related tasks are completed.",
          ...
          reasoning:
            "You frequently have tasks linked to goals but manually update progress.",
          evidence: [
        ...
        },
        {
          ...
          description:
            "Suggest breaks based on your productivity patterns and task complexity.",
            ...
            smart_actions: [
              {
                ...
                parameters: {
                  ...
                  message:
                    "Consider taking a 10-minute break to maintain productivity",
          ...
          reasoning:
            "Your productivity data shows optimal performance with regular breaks.",
          evidence: [
      ...
      const mockInsights: AIInsight[] = [
        {
          ...
          description:
            "Your most productive hours are between 9-11 AM and 2-4 PM. Consider scheduling important tasks during these times.",
          data: {
        ...
        },
        {
          ...
          description:
            "Grouping similar tasks together could save 25% of your time based on context switching analysis.",
          data: {
            context_switches: 47,
