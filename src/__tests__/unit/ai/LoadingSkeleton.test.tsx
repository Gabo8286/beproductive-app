...
describe("LoadingSkeleton", () => {
  ...
  it("renders banner skeleton when type is banner", () => {
    ...
    expect(
      container.querySelector(".border-l-4.border-l-purple-500"),
    ).toBeInTheDocument();
  ...
  it("applies custom className to banner type", () => {
    const { container } = render(
      <LoadingSkeleton type="banner" className="banner-custom" />,
    );
  ...
  it("applies custom className to tracker type", () => {
    const { container } = render(
      <LoadingSkeleton type="tracker" className="tracker-custom" />,
    );
  ...
  it("applies custom className to page type", () => {
    const { container } = render(
      <LoadingSkeleton type="page" className="page-custom" />,
    );
