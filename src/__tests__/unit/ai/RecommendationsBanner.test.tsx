...
describe("RecommendationsBanner", () => {
  ...
  it("renders goals context recommendations", () => {
    ...
    expect(
      screen.getByText("Weekly goal reviews increase achievement rates by 40%"),
    ).toBeInTheDocument();
    expect(screen.getByText("productivity")).toBeInTheDocument();
  ...
  it("displays correct type colors for different recommendation types", () => {
    ...
    expect(productivityBadge).toHaveClass(
      "bg-blue-100",
      "text-blue-800",
      "border-blue-200",
    );
  ...
  it("shows AI insights navigation link", () => {
    ...
    const aiInsightsButton = sparklesButtons.find(
      (button) => button.querySelector("svg"), // Looking for the Sparkles icon
    );
  ...
  it("displays wellness recommendation styling correctly", () => {
    ...
    expect(wellnessBadge).toHaveClass(
      "bg-green-100",
      "text-green-800",
      "border-green-200",
    );
  ...
  it("displays learning recommendation styling correctly", () => {
    ...
    expect(learningBadge).toHaveClass(
      "bg-purple-100",
      "text-purple-800",
      "border-purple-200",
    );
  ...
  it("displays optimization recommendation styling correctly", () => {
    ...
    waitFor(() => {
      ...
      expect(optimizationBadge).toHaveClass(
        "bg-orange-100",
        "text-orange-800",
        "border-orange-200",
      );
