...
describe('NotesGrid', () => {
  ...
  it('renders empty state when no notes', () => {
    ...
    expect(screen.getByText('Start Your Knowledge Journey')).toBeInTheDocument();
  ...
  it('calls onNoteClick when note is clicked', () => {
    ...
    const noteCard = screen.getByText('Test Note 1').closest('[role="button"], [tabindex], button, [onclick], .cursor-pointer');
