...
export class AIDataFactory {
  static createTimeEntry(
    ...
    return {
      ...
      tags: faker.helpers.arrayElements(
        ["coding", "design", "meeting", "research", "documentation"],
        3,
      ),
      ...
      ai_insights: [faker.lorem.sentence(), faker.lorem.sentence()],
      ...overrides,
    };
  }
  ...
  static createTimeEstimate(
    overrides: Partial<MockTimeEstimate> = {},
  ): MockTimeEstimate {
    return {
      id: faker.string.uuid(),
      taskId: faker.string.uuid(),
      estimated_duration: faker.number.int({ min: 900000, max: 14400000 }), // 15 minutes to 4 hours
      confidence_level: faker.number.float({
        min: 0.5,
        max: 1,
        fractionDigits: 2,
      }),
      factors: this.createEstimationFactors(3),
      historical_accuracy: faker.number.float({
        min: 0.6,
        max: 0.95,
        fractionDigits: 2,
      }),
  ...
  static createSmartRecommendation(
    overrides: Partial<MockSmartRecommendation> = {},
  ): MockSmartRecommendation {
    const recommendations = [
      {
        title: "Schedule deep work blocks",
        description:
          "Block 2-3 hour chunks for focused work during your peak productivity hours",
      ...
      },
      {
        ...
        description:
          "Short breaks every 90 minutes help maintain focus and prevent burnout",
      ...
      },
      {
        ...
        description:
          "Improve your planning skills with better time estimation techniques",
  ...
  static createProductivityPattern(
    overrides: Partial<MockProductivityPattern> = {},
  ): MockProductivityPattern {
    ...
    return {
      ...
      avg_productivity: faker.number.float({
        min: 6.0,
        max: 9.5,
        fractionDigits: 1,
      }),
      ...
      optimal_task_types: faker.helpers.arrayElements(
        ["deep_work", "meetings", "admin", "creative"],
        2,
      ),
  ...
  static createAIInsight(
    overrides: Partial<MockAIInsight> = {},
  ): MockAIInsight {
    const insights = [
      {
        type: "productivity" as const,
      ...
      },
      {
        ...
        description:
          "You take breaks every 90 minutes on average - great for focus!",
        category: "behavior",
      },
      {
    ...
    return {
      ...
      metadata: {
        source: "ai_engine",
        version: "1.0.0",
        correlationScore: faker.number.float({
          min: 0.5,
          max: 1.0,
          fractionDigits: 2,
        }),
  ...
  static createTaskRecommendations(): MockSmartRecommendation[] {
    return [
      ...
      this.createSmartRecommendation({
        ...
        reasoning:
          "Historical data shows highest completion rates during these hours",
  ...
  static createGeneralRecommendations(): MockSmartRecommendation[] {
    return [
      this.createSmartRecommendation({
        ...
        reasoning:
          "Regular breaks prevent fatigue and maintain cognitive performance",
...
export class MockAIEngine {
  ...
  static generateProductivityPatterns(
    count: number = 4,
  ): MockProductivityPattern[] {
